...
public class JmsSyncConsumerTest extends PollingJmsConsumerCase {
  ...
  public void testDeferConsumerCreationToVendor() throws Exception {
    ...
    ActiveMQJMSConnectionFactory factory = new ActiveMQJMSConnectionFactory("vm://" + activeMqBroker.getName());
  ...
  public void testDefaultFalseDeferConsumerCreationToVendor() throws Exception {
    ...
    when(mockVendor.createConnectionFactory()).thenReturn(new ActiveMQJMSConnectionFactory("vm://" + activeMqBroker.getName()));
