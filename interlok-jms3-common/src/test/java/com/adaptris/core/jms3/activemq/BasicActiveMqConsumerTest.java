...
import com.adaptris.core.jms3.AutoConvertMessageTranslator;
import com.adaptris.core.jms3.BytesMessageTranslator;
import com.adaptris.core.jms3.DefinedJmsProducer;
import com.adaptris.core.jms3.JmsConnection;
import com.adaptris.core.jms3.JmsConsumerCase;
...
public class BasicActiveMqConsumerTest
  ...
  public void testQueue_ProduceWhenConsumerStopped() throws Exception {
    ...
    Channel channel = createChannel(activeMqBroker.getJmsConnection(), workflow);
  ...
  private Adapter createDurableSubsAdapter(String adapterName, EmbeddedArtemis activeMqBroker) throws Exception {
