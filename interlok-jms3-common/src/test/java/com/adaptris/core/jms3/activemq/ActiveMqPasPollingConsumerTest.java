...
import com.adaptris.core.jms3.PasPollingConsumer;
...
public class ActiveMqPasPollingConsumerTest {
  ...
  private StandaloneConsumer createStandalone(EmbeddedArtemis mq, String threadName, String destinationName) throws Exception {
