...
import com.adaptris.core.jms3.ActiveJmsConnectionErrorHandler;
...
public class ActiveJmsConnectionErrorHandlerTest
  ...
  public void testConnectionErrorHandler(TestInfo info) throws Exception {
    ...
    JmsConnection jmsCon = activeMqBroker.getJmsConnection();
  ...
  private MockChannel createChannel(EmbeddedArtemis mq, JmsConnection con, String destName, TestInfo info) throws Exception {
    MockChannel result = new MockChannel();
  ...
  private Workflow createWorkflow(EmbeddedArtemis mq, String destName) throws Exception {
  ...
  private class MyStandardJndiImpl extends StandardJndiImplementation {
    ...
    /**
     * @see com.adaptris.core.jms3.VendorImplementationImp #retrieveBrokerDetailsForLogging()
     */
    @Override
