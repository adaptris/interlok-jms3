...
public class JmsTransactedWorkflowTest
  ...
  private Channel createStartableChannel(EmbeddedArtemis broker) throws Exception {
    return createStartableChannel(new ArrayList<Service>(), broker, getName());
  }

  private Channel createStartableChannel(List<Service> services, EmbeddedArtemis broker, String destinationName) throws Exception {
  ...
  private Channel createChannel(EmbeddedArtemis broker) throws Exception {
