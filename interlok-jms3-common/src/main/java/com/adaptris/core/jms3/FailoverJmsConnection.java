 ...
 * </p>
 * 
 * @config failover-jms3-connection
 * 
 * @author sellidge
 * @author $Author: lchan $
 */
@XStreamAlias("failover-jms3-connection")
@AdapterComponent
...
public class FailoverJmsConnection extends JmsConnection {
  ...
  /**
   *
   * @see com.adaptris.core.jms3.JmsConnection#startConnection()
   */
  @Override
  ...
  /**
   *
   * @see com.adaptris.core.jms3.JmsConnection#stopConnection()
   */
  @Override
  ...
  /**
   *
   * @see com.adaptris.core.jms3.JmsConnection#closeConnection()
   */
  @Override
