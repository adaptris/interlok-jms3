 ...
 * </p>
 *
 * @config active-jms3-connection-error-handler
 */
@XStreamAlias("active-jms3-connection-error-handler")
      ...
      try {
        ...
        while (isActive) {
          ...
          try {
            ...
            messageProducer.setDeliveryMode(jakarta.jms.DeliveryMode.NON_PERSISTENT);
