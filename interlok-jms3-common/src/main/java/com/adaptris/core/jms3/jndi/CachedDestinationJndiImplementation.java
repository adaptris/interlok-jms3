...
import com.adaptris.core.jms3.JmsActorConfig;
 ...
 * to reset the cache is to create a new instance.</strong> If this {@link com.adaptris.core.jms3.VendorImplementation} is used as
 * part of a
 ...
 * </p>
 * 
 * @config jms3-cached-destination-jndi-implementation
 * 
 * @see StandardJndiImplementation
 */
@XStreamAlias("jms3-cached-destination-jndi-implementation")
