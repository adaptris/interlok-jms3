 ...
 * </p>
 * 
 * @config jms3-metadata-correlation-id-source
 */
@XStreamAlias("jms3-metadata-correlation-id-source")
...
public class MetadataCorrelationIdSource implements CorrelationIdSource {
   ...
   * </p>
   *
   * @see com.adaptris.core.jms3.CorrelationIdSource#processCorrelationId
